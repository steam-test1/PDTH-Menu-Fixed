...
PDTH_Menu.hook_files = {
    ...
    ["lib/tweak_data/tweakdata"] = "Menu/tweakdata.lua"
    -- ["lib/managers/menu/mainmenugui"] = "Menu/mainmenugui.lua"
...
if not PDTH_Menu.setup and Hooks then
    ...
    PDTHMenu_font = PDTH_Menu.options.font_enable and "fonts/font_small_shadow" or "fonts/font_medium_mf"
